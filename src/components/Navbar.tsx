            ...
            >
                ...
                <div className="flex-1 flex justify-end items-center gap-3 w-full sm:w-auto">
                    ...
                    <a
                        ...
                        className="hidden sm:inline-flex px-4 py-2 text-sm font-semibold rounded-full bg-gradient-to-r from-[var(--accent)] to-[var(--accent-secondary)] text-black hover:opacity-90 hover:shadow-[0_0_15px_rgba(160,232,230,0.4)] transition-all"
                    >
                        Hire Me
                    </a>
                </div>
