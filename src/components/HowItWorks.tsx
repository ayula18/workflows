...
export default function HowItWorks({ steps }: HowItWorksProps) {
    return (
        <SectionWrapper id="how-it-works" className="bg-[var(--card-bg)]/30 border-y border-[var(--card-border)] backdrop-blur-sm">
            <div className="text-center mb-16">
                <h2 className="text-3xl md:text-5xl font-bold mb-4">
                    How the workflow runs <span className="text-gradient">end to end</span>
                </h2>
                <p className="text-[var(--foreground)] opacity-60">From raw data to booked meetings in {steps.length} autonomous steps</p>
            </div>
