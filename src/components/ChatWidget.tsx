            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        {/* ── Header ── */}
                        <div
                            className="flex items-center gap-3 px-5 py-4 border-b border-slate-200 dark:border-white/10 bg-gradient-to-br from-slate-100 to-white dark:from-[rgba(160,232,230,0.12)] dark:to-[rgba(209,167,255,0.12)]"
                        >
                            <div
                            ...
                            <button
                                ...
                                className="flex h-8 w-8 items-center justify-center rounded-full transition-colors hover:bg-slate-200 dark:hover:bg-white/10 cursor-pointer"
                            >
                        ...
                        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 custom-scrollbar">
                                ...
                                >
                                    <div
                                        className={`relative max-w-[80%] rounded-2xl px-4 py-2.5 text-[13.5px] leading-relaxed ${msg.role === "user"
                                            ? "rounded-br-md text-slate-900 dark:text-white bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100 dark:from-[rgba(160,232,230,0.25)] dark:to-[rgba(209,167,255,0.25)] dark:border-[rgba(160,232,230,0.2)]"
                                            : "rounded-bl-md text-slate-800 dark:text-white/90 bg-slate-50 border border-slate-200 dark:bg-white/5 dark:border-white/10"
                                            }`}
                                    >
                                        {msg.role === "bot" ? (
                            ...
                            {isTyping && (
                                ...
                                >
                                    <div
                                        className="flex items-center gap-1 rounded-2xl rounded-bl-md px-4 py-3 bg-slate-50 border border-slate-200 dark:bg-white/5 dark:border-white/10"
                                    >
                                        {[0, 1, 2].map((idx) => (
                                            <span
                                                key={idx}
                        ...
                        <form
                            ...
                            className="flex items-center gap-2 px-4 py-3 border-t border-slate-200 dark:border-white/10 bg-slate-50/50 dark:bg-black/25"
                        >
                            <input
                                ref={inputRef}
                                type="text"
