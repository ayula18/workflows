...
export default function PreviewPanel({ data }: PreviewPanelProps) {
    ...
    return (
        <div className="rounded-2xl p-6 relative overflow-hidden border border-slate-200 dark:border-white/10 shadow-lg dark:shadow-2xl bg-white dark:bg-[#0B0F19]">
            ...
            {data.type === 'deal-kit' && data.dealKit ? (
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-600 dark:text-gray-300 opacity-90 leading-relaxed max-w-sm">&quot;{data.dealKit.summary}&quot;</p>
                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-y-2 text-sm">
                            ...
                            <div className="font-medium bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded px-2 py-1 w-fit">{data.fraudCase.callType}</div>
                            ...
                            <div className="font-medium text-red-400 mt-1">&quot;{data.fraudCase.riskLevel}&quot; <span className="text-xs opacity-60 ml-1 text-slate-500 dark:text-white">(Flagged)</span></div>
                        </div>
                    </div>
